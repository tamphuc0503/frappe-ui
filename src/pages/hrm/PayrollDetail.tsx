...
import { ArrowLeft, Calendar, Building2, Briefcase, User } from 'lucide-react'
...
export function PayrollDetail() {
  ...
  return (
    <div className="flex flex-col h-full page-slide-enter">
      {/* Header */}
      <div className="flex items-center gap-3 pb-4 border-b border-gray-100 mb-6 flex-shrink-0">
        <button
          type="button"
          onClick={goBack}
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-lg font-bold text-gray-900 truncate">
            Payslip: {detail.employeeName || detail.employee}
          </h1>
