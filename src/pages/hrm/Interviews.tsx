...
import { ChevronLeft, ChevronRight, Calendar, Clock, Star, X, ExternalLink, Users } from 'lucide-react'
...
export function Interviews() {
  ...
  if (pageLoading || loading) return <InterviewsSkeleton />

  const todayKey = toDateKey(today)

  return (
    <div className="h-full flex flex-col min-h-0">
      <PageHeader title="Interviews" subtitle="Calendar view of all scheduled interviews" />
